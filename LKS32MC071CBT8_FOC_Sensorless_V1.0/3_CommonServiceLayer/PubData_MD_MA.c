...
void updateSVPWMParaMALayer(PSTR_ControlObject pCtrlObj)
{
...
#if (DRV0_CUR_SAMP_TYPE == CURRENT_SAMPLE_1SHUNT)
    {
        ...
        t_wTmp32 = pCtrlObj->m_pDrvCfgPara->mS_GlobalCfg.m_nuDeadZone + pCtrlObj->m_pDrvCfgPara->mS_FBCurSense.nCurSampStableTime + pCtrlObj->m_pDrvCfgPara->mS_FBCurSense.nCurSampADConvTime;
        ...
        t_wTmp32 = pCtrlObj->m_pDrvCfgPara->mS_GlobalCfg.m_nuDeadZone + pCtrlObj->m_pDrvCfgPara->mS_FBCurSense.nCurSampStableTime;
        t_wTmp32 = (s64)t_wTmp32 * pCtrlObj->m_pDrvCfgPara->mS_GlobalCfg.m_nPWMClkFreq / 1000;
...
#else
    {
        ...
        // (Tdead + Tstable)
        t_wTmp32_1 = pCtrlObj->m_pDrvCfgPara->mS_GlobalCfg.m_nuDeadZone + pCtrlObj->m_pDrvCfgPara->mS_FBCurSense.nCurSampStableTime;
