...
volatile const STR_DrvCfgGlobal tS_DrvCfgGlobal __attribute__((at(ADDR_PARA_LOCATION))) = DRV_CFG_GLOBAL_PARA_TAB;
...
bool checkParaCfgValid(void)
{
    ...
    if ((tS_DrvCfgGlobal.header == PARA_CFG_HEADER) && (tS_DrvCfgGlobal.mainVersion == PARA_CFG_MAIN_VERSION) &&
        (tS_DrvCfgGlobal.version == PARA_CFG_VERSION) && (tS_DrvCfgGlobal.subversion == PARA_CFG_SUB_VERSION) &&
        (tS_DrvCfgGlobal.length == PARA_CFG_LENGTH) && (tS_DrvCfgGlobal.objNumber == PARA_CFG_NUMBER)) {
