...
{
    s32 t_nTmp;
    t_nTmp = (s32)gS_FocObjM[t_bObjId].m_pStatCurrAB->nAlph * gS_FocObjM[t_bObjId].m_pStatCurrAB->nAlph + (s32)gS_FocObjM[t_bObjId].m_pStatCurrAB->nBeta * gS_FocObjM[t_bObjId].m_pStatCurrAB->nBeta;
...
{
    s32 t_nTmp;
    t_nTmp = (s32)getMotorDaxisVoltFormObjId(t_bObjId) * getMotorDaxisVoltFormObjId(t_bObjId) + (s32)getMotorQaxisVoltFormObjId(t_bObjId) * getMotorQaxisVoltFormObjId(t_bObjId);
