...
// 芯片内部运放放大比例=320：10k，外接的是两个20k 放大倍数320/50 = 6.4， PGA_GAIN_4:增益4
#define AMPLIFICATION_GAIN_M0 (6.4) /*运放放大倍数*/ // 3.6/(6.4 * 0.005)= 112.5A
...
#define U_MOTOR_PP_M0 (4.0)   /* 电机极对数 */
#define U_MOTOR_RS_M0 (0.89)  /* 单位: Ω 电机相电阻 */
#define U_MOTOR_LD_M0 (620.0) //(8000.0)          /* 单位: uH 电机d轴电感 */
#define U_MOTOR_LQ_M0 (620.0) //(10000.0)         /* 单位: uH 电机q轴电感 */
